import { signalSender, fileUploader, jsonLoader } from "./commonFunctions.js";
...
let cachedMenus = {}, html = null, timeOut = null;
...
export async function initializeMenu(waqName){
    ...
    const params = getState().currentParams;
    const waqModel = getState().waqModel;
