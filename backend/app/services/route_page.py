import os, traceback, msgpack
from fastapi import APIRouter, Request, Depends
from fastapi.responses import HTMLResponse
from fastapi.templating import Jinja2Templates
from app.config import SOURCE_FRONTEND, SOURCE_BACKEND, PROJECT_ROOT
...
#     template_path = os.path.normpath(os.path.join(SOURCE_FRONTEND, "templates", template_file))
...
#         html.append('</div>')
#         return ''.join(html)
#     path = os.path.normpath(os.path.join(SOURCE_FRONTEND, "templates", htmlFile))
